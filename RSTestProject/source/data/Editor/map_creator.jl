...
$LOG_FILE(s, "joblists/logs/joblist_%%MAP_DIR_NAME%%.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/%%MAP_DIR_NAME%%/%%MAP_DIR_NAME%%.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/%%MAP_DIR_NAME%%/%%MAP_DIR_NAME%%.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "%%MAP_DIR_NAME%%_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "%%MAP_DIR_NAME%%_ovr.scr")
