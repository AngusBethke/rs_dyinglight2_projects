...
$LOG_FILE(s, "joblists/logs/joblist_rs_islands.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/rs_islands/rs_islands.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/rs_islands/rs_islands.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "rs_islands_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "rs_islands_ovr.scr")
