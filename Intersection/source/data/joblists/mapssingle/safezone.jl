...
$LOG_FILE(s, "joblists/logs/joblist_safezone.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/safezone/safezone.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/safezone/safezone.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "safezone_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "safezone_ovr.scr")
