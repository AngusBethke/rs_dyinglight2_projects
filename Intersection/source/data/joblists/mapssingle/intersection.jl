...
$LOG_FILE(s, "joblists/logs/joblist_Intersection.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/Intersection/Intersection.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/Intersection/Intersection.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "Intersection_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "Intersection_ovr.scr")
