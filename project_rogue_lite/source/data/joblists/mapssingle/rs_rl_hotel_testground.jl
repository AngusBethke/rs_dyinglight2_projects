...
$LOG_FILE(s, "joblists/logs/joblist_rs_rl_hotel_testground.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/rs_rl_hotel_testground/rs_rl_hotel_testground.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/rs_rl_hotel_testground/rs_rl_hotel_testground.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "rs_rl_hotel_testground_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "rs_rl_hotel_testground_ovr.scr")
