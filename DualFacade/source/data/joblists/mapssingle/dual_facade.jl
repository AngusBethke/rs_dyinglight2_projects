...
$LOG_FILE(s, "joblists/logs/joblist_dual_facade.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/dual_facade/dual_facade.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/dual_facade/dual_facade.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "dual_facade_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "dual_facade_ovr.scr")
