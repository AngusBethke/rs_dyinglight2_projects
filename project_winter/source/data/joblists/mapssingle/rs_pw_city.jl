...
$LOG_FILE(s, "joblists/logs/joblist_rs_pw_city.log")
LogFile( LOG_FILE )

//
// Map file
//
$MAP_FILE (s, "maps/rs_pw_city/rs_pw_city.map")

//
// Gather resources
//
$PACK_FILE (s, "maps/rs_pw_city/rs_pw_city.rscr")
$RLOG0 (s, "common.rlog")
$RLOG1 (s, "rs_pw_city_resources.scr")
$RLOG2 (s, "")
$RLOG3 (s, "")
$RLOG4 (s, "")
...
$RLOGEXCL6 (s, "")
$RLOGEXCL7 (s, "")
$OVERRIDE_SCRIPT (s, "rs_pw_city_ovr.scr")
